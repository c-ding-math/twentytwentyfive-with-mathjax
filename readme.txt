...
Twenty Twenty-Five With MathJax adds MathJax support to the official WordPress Twenty Twenty-Five theme. With this theme, text enclosed in $...$ will render as inline math, while text enclosed in $$...$$ will rendered as display math. If you're unable to install plugins on WordPress.com, this theme provides an easy way to enable MathJax functionality.
